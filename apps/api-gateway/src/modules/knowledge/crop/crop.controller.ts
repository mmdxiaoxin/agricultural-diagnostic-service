...
export class CropController {
  ...
  @ApiResponse(HttpStatus.CREATED, '创建成功', CropDto)
  ...
  @ApiResponse(HttpStatus.OK, '获取成功', CropDto, true)
  @ApiErrorResponse(HttpStatus.UNAUTHORIZED, '未授权访问')
  @ApiErrorResponse(HttpStatus.FORBIDDEN, '权限不足')
  findAll() {
  ...
  @ApiResponse(HttpStatus.OK, '获取成功', createPageResponseDto(CropDto))
  @ApiErrorResponse(HttpStatus.UNAUTHORIZED, '未授权访问')
  @ApiErrorResponse(HttpStatus.FORBIDDEN, '权限不足')
  ...
  @ApiResponse(HttpStatus.OK, '获取成功', CropDto)
  @ApiErrorResponse(HttpStatus.UNAUTHORIZED, '未授权访问')
  @ApiErrorResponse(HttpStatus.FORBIDDEN, '权限不足')
  ...
  @ApiParam({ name: 'id', description: '作物ID', type: 'number' })
  @ApiResponse(HttpStatus.OK, '更新成功', CropDto)
  @ApiErrorResponse(HttpStatus.BAD_REQUEST, '请求参数错误')
  @ApiErrorResponse(HttpStatus.UNAUTHORIZED, '未授权访问')
  @ApiErrorResponse(HttpStatus.FORBIDDEN, '权限不足')
  @ApiErrorResponse(HttpStatus.NOT_FOUND, '作物不存在')
